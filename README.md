...
#### In this practice  we use Naive Bayes.
...
1. From the Iris.csv dataset found at https://github.com/jcromerohdz/iris, elaborate the cleanliness of data necessary to be processed by the following algorithm (Important, this cleaning must be by means of Scala script in Spark). to. Use Spark's Mllib library the Machine Learning algorithm called multilayer perceptron
...
#### In this practice  we use multilayer perceptron.
