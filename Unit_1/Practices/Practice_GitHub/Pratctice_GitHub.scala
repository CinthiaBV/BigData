...
as well as making a mistake when creating the SSH key and its respective passwords, however, I think it's all 
a matter of practice, to be able to memorize the commands and thus everything is easier